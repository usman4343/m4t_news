                            ...
                            foreach ($audit as $key => $task) {
                                ...
                                if (is_array($task->value)) {
                                    ...
                                    if ($task->name === 'Links') {
                                        ...
                                        $task->value->pinterestShare = number_format_i18n($task->value->pinterestShare);
                                        ...
                                        $replace .= '<ul class="sq_analytics_values" >
                                                    ...
                                                    <li>
                                                        <div class="sq_analytics_values_title">' . __('Pinterest shares') . '</div>
                                                        <div class="sq_analytics_values_value">' . $task->value->pinterestShare . '</div>
                                                        <div class="sq_rank_sprite sq_rank_flag_pinterest"></div>
                                                    </li>
                                                </ul>';
