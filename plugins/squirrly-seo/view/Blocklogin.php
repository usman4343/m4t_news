<div id="sq_blocklogin" class="sq_box">
    ...
    <div class="sq_body">
        <ul style="display: none;">
            ...
            <li>
                <a id="sq_signup" href="javascript:void(0);" target="_blank" title="<?php _e('Register', _SQ_PLUGIN_NAME_); ?>"><?php _e('Register to Squirrly.co', _SQ_PLUGIN_NAME_); ?></a> |
        ...
        <div id="sq_autologin" align="center">
            ...
            <div id="sq_termsdiv">
                <input type="checkbox" id="sq_terms" style="height: 18px;width: 18px; margin: 0 10px;"/><?php echo sprintf(__('I Agree with the %sSquirrly Terms%s', _SQ_PLUGIN_NAME_), '<a href="http://www.squirrly.co/terms-of-use#page-block-lvtsrakgujgzxgvi" target="_blank" >', '</a>'); ?>
            </div>
    ...
    <script type="text/javascript">
        ...
        jQuery('#sq_loginimage').on('click', function () {
            jQuery('#sq_blocklogin').sq_blocklogin().sq_autoLogin();
        });
...
<div id="sq_login_success" style="display: none;">
    <div class="sq_header"><?php _e('Congratulations! You are ready to use all the features from Squirrly', _SQ_PLUGIN_NAME_); ?>
        <div><img src="<?php echo _SQ_THEME_URL_ . 'img/settings/squirrly.png' ?>"></div>
    </div>
