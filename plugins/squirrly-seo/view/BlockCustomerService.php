        ...
        <div id="sq_settings_body">
            <fieldset>
                <legend>
                    ...
                    <span><?php echo sprintf(__('%sSupport Community%s >> Join us on Google Plus', _SQ_PLUGIN_NAME_), '<a href="https://plus.google.com/communities/104196720668136264985" target="_blank">', '</a>'); ?></span>
