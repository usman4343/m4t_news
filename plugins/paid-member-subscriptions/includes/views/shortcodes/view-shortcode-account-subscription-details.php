	...
	<table class="pms-account-subscription-details-table">
		<tbody>
            ...
            <tr>
                ...
                <td><?php echo ( ! empty( $member_subscription->start_date ) ? date( get_option('date_format'), strtotime( $member_subscription->start_date ) ) : '' ); ?></td>
            </tr>

            <!-- Subscription expiration date -->
            <tr>
                <td><?php echo __( 'Expiration Date', 'paid-member-subscriptions' ); ?></td>
                <td><?php echo ( ! empty( $member_subscription->expiration_date ) ? date( get_option('date_format'), strtotime( $member_subscription->expiration_date ) ) : __( 'Unlimited', 'paid-member-subscriptions' ) ); ?></td>
            </tr>
            ...
            <?php if( $member_subscription->is_trial_period() ): ?>
                <tr>
                    ...
                    <td><?php echo date( get_option('date_format'), strtotime( $member_subscription->trial_end ) ); ?></td>
                </tr>
            <?php endif; ?>
            ...
            <tr>
                ...
                <td><?php echo date( get_option('date_format'), strtotime( $member_subscription->billing_next_payment ) ); ?></td>
            </tr>
            <?php endif; ?>
