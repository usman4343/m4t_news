					...
					if( isset($fullItemDetails->graphql->shortcode_media->shortcode	) && trim($fullItemDetails->graphql->shortcode_media->shortcode) == $t_data['item_id'] ){
						...
						if(isset($temp['is_video']) && $temp['is_video'] == 'yes' ){
							...
							if ( in_array('OPT_IT_VID_TOP', $camp_opt) ){
								$temp['item_description']= '[embed]' . $fullItemDetails->graphql->shortcode_media->video_url .'[/embed]' . $temp['item_description'];
							}else{
								$temp['item_description'].= '[embed]' . $fullItemDetails->graphql->shortcode_media->video_url .'[/embed]';
							}
