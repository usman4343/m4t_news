...
<div class="wrap">
	...
	<p><strong>It is where</strong> you can configure the plugin. choose your language, spinning method, configure the cron & set things up.</p>
					...
					<div>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<input name="wp_auto_spin[]"  value="OPT_AUTO_SPIN_DRAFT" type="checkbox">By default draft posts get spinned once published tick here if you don't want them to wait untill published    
												
										</tr>
										
										<tr>
											<th scope="row"><label>Disable Spining Queue? </label></th>
											<td>
												...
												<div style="padding-top:5px" class="description">Tick this option to disable the <a href="<?php echo $queue_url ?>">spinning queue</a> so the cron will not process any item from the queue (be carefull this option will stop spinning items in the queue)</div>
										...
										<tr>
											...
											<td>
												<input name="wp_auto_spin[]"   value="OPT_AUTO_SPIN_NO_THESAURUS" type="checkbox">  Disable plugin synonyms usage
												<div style="padding-top:5px" class="description">Tick this option to disable using the internal plugin synonyms in case you will only use your custom added synonyms at the My Thesaurus tab. </div>
										</tr>
						...
						<div class="postbox" >
							...
							<div class="inside">
								...
								<table class="form-table">
									<tbody>
										...
										<tr>
											<th scope="row"><label>Exclude Capped Words </label></th>
											<td>
										...
										<tr>
											...
											<input name="wp_auto_spin[]" value="OPT_AUTO_SPIN_URL_EX" type="checkbox"> <span class="option-title"> Tick this to skip spinning urls written without the hyperlink html tag. i.e not hyperlinked </span>
										</tr>
										...
										<tr>
											...
											<input name="wp_auto_spin[]" value="OPT_AUTO_SPIN_CURLY_EX" type="checkbox"> <span class="option-title"> This will exclude quotes between single ‘ ’ and double “ ” curely quotes. </span>
										</tr>
										...
										<tr>
											...
											<input name="wp_auto_spin[]" value="OPT_AUTO_SPIN_CURLY_EX_R" type="checkbox"> <span class="option-title"> This will exclude quotes between double regular quotes " ". </span>
										</tr>
							...
							<div class="inside">
								...
								<p>By Default, the plugin uses it's internal synonyms database but you still can use any of 6 most popular APIs to spin the posts .</p>
								...
								<table  class="form-table">
									...
									*/
									...
									<tr>
										...
										<td>Activating options below may cause html layout to break so use carefully and if you got html broken,deactivate them. unfortunately html tags locations may get messed using these options.</td>
									</tr>
						...
						<div class="postbox OPT_AUTO_SPIN_WORDAI  spin_method_box " >
							...
							<div class="inside">
								...
								<p>By Default, the plugin uses it's internal synonyms database but you still can use <a href="http://wordai.com/?ref=4ha50">WordAI</a> API to spin the posts .</p>
								...
								<table  class="form-table">
									...
									<tr>
										...
										<td><input  style="width:100%" value="<?php echo $wp_auto_spinner_wordai_quality ;  ?>" name="wp_auto_spinner_wordai_quality"   type="text">
										<div class="description">A numeric value between 0 and 100. The lower the number, the more unique, and the higher the number, the more readable.</div>
										</td>
									</tr>
									
									<tr>
										<th scope="row">Sentence</th>
										<td><input name="wp_auto_spin[]" value="OPT_AUTO_SPIN_WORDAI_SENTENCE" type="checkbox"> <span class="option-title"> Tick if you want paragraph editing, where WordAi will add, remove, or switch around the order of sentences in a paragraph (recommended!). </span></td>
									</tr>
									
									<tr>
										<th scope="row">Paragraph</th>
										<td><input name="wp_auto_spin[]" value="OPT_AUTO_SPIN_WORDAI_PARAGRAPH" type="checkbox"> <span class="option-title"> If you want WordAi to do paragraph spinning - perfect for if you plan on using the same spintax many times. </span></td>
									</tr>
						...
						<div class="postbox OPT_AUTO_SPIN_TBS  spin_method_box" >
							...
							<div class="inside">
								...
								<p>By Default, the plugin uses it's internal synonyms database but you still can use <a href="http://sweetheatmn.jonathanleger.zaxaa.com/s/4152949213724">TheBestSPinner</a> API to spin the posts .</p>
						...
						<div class="postbox OPT_AUTO_SPIN_CP spin_method_box" >
							...
							<div class="inside">
								...
								<p>By Default, the plugin uses it's internal synonyms database but you still can use <a href="http://www.contentprofessor.com/go.php?offer=sweetheatm">ContentProfessor</a> API to spin the posts .</p>
						...
						<div class="postbox OPT_AUTO_SPIN_CR spin_method_box" >
							...
							<div class="inside">
								...
								<p>By Default, the plugin uses it's internal synonyms database but you still can use <a href="http://chimprewriter.com?a_aid=55006517c7d97">ChimpRewriter</a> API to spin the posts .</p>
