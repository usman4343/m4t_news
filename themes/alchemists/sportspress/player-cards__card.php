					...
					echo '<div class="team-roster__player-details-body">';
						...
						if ( !empty( $shpercent )) :
							echo '<div class="progress-stats progress-stats--top-labels">';
								echo '<div class="progress__label">' . esc_html( 'Shot %', 'alchemists' ) .'</div>';
						...
						if ( !empty( $passpercent )) :
							echo '<div class="progress-stats progress-stats--top-labels">';
								echo '<div class="progress__label">' . esc_html( 'Pass %', 'alchemists' ) .'</div>';
								echo '<div class="progress">';
						...
						echo '<footer class="team-roster__player-details-footer">';
							echo '<a href="' . get_permalink( $id ) . '" class="btn btn-sm btn-block btn-primary-inverse">' . esc_html( 'Read More', 'alchemists' ) . '</a>';
						echo '</footer>';
