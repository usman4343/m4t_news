...
foreach ( $groups as $group ):
	...
	$output .= '<div class="table-responsive sp-table-wrapper">' .
		'<table class="table table--lg team-roster-table sp-player-list sp-data-table' . ( $sortable ? ' sp-sortable-table' : '' ) . ( $scrollable ? ' sp-scrollable-table' : '' ) . ( $paginated ? ' sp-paginated-table' : '' ) . '" data-sp-rows="' . $rows . '">' . '<thead>' . '<tr>';
