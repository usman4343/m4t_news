...
<div class="sp-template sp-template-event-list card card--has-table">
	...
	<div class="card__content">
		<div class="sp-table-wrapper table-responsive">
			<table class="table table-hover team-schedule team-schedule--full sp-event-list sp-event-list-format-<?php echo esc_attr( $title_format ); ?> sp-data-table<?php if ( $paginated ) { ?> sp-paginated-table<?php } if ( $sortable ) { ?> sp-sortable-table<?php } if ( $scrollable ) { ?> sp-scrollable-table<?php } ?>" data-sp-rows="<?php echo esc_attr( $rows ); ?>">
				<thead>
					<tr>
						<?php
