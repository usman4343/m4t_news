	...
	<div class="card__content">
		<div class="sp-table-wrapper">
			<div class="table-responsive">
				<table class="table sp-event-performance sp-data-table<?php if ( $mode == 'values' ) { ?><?php if ( $scrollable ) { ?> sp-scrollable-table<?php } ?><?php if ( $sortable ) { ?> sp-sortable-table<?php } ?><?php } ?>">
					<thead>
						<tr>
							<?php if ( $mode == 'values' ): ?>
								<?php if ( $show_players ): ?>
							...
							if ( $show_total && ( ! $primary || sizeof( array_intersect_key( $totals, array_flip( (array) $primary ) ) ) ) ) {
								...
								<tr class="sp-total-row <?php echo ( $i % 2 == 0 ? 'odd' : 'even' ); ?>">
									...
									if ( $show_players ):
										...
										if ( $mode == 'values' ):
											echo '<td class="data-name">' . esc_html__( 'Total', 'alchemists' ) . '</td>';
										endif;
									endif;
